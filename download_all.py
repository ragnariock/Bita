...
# 				'vape in the store']
#search_queries = ['vape shop','GLO smoking','IQOS smoking']

#search_queries = ['smoking cigarette','cigarette in hand','Image of smoking people']

#search_queries = ['juul','vape pen','wax vape','smok vape pen','voopoo','smoking voopoo','nord vape']

search_queries = ['baseball bat','bat','bat in hand']
